...
const DefectiveStock = React.lazy(() => import("./pages/DefectiveStock"));
const Expenses = React.lazy(() => import("./pages/Expenses"));
const DepensesCopt = React.lazy(() => import("./pages/DepensesCopt"));
const Revenue = React.lazy(() => import("./pages/Revenue"));
const Reports = React.lazy(() => import("./pages/Reports"));
const FuelManagement = React.lazy(() => import("./pages/FuelManagement"));
const PetitCamion = React.lazy(() => import("./pages/PetitCamion"));
